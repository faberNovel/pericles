...
Rails.application.config.assets.precompile += %w( resources/form.js )
Rails.application.config.assets.precompile += %w( responses/form.js )
Rails.application.config.assets.precompile += %w( security_schemes/form.js )
Rails.application.config.assets.precompile += %w( regex-colorizer.js )
Rails.application.config.assets.precompile += %w( regex.js )
Rails.application.config.assets.precompile += %w( mock_profiles/form.js )
Rails.application.config.assets.precompile += %w( resources/new_representation.js )