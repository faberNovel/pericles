  ...
  test "find_parent_resource_representations should return all parent resource_representations
   for a given resource representation" do
     ...
     create(:attributes_resource_representation,
       parent_resource_representation: parent_resource_representation,
       resource_attribute: resource_attribute,
       resource_representation: resource_representation
     )

     grand_parent_resource = create(:resource, project: project)
     parent_resource_attribute = create(:attribute_with_resource,
       parent_resource: grand_parent_resource,
       resource: parent_resource
     )
     grand_parent_resource_representation = create(:resource_representation, resource: grand_parent_resource)
     create(:attributes_resource_representation,
       parent_resource_representation: grand_parent_resource_representation,
       resource_attribute: parent_resource_attribute,
       resource_representation: parent_resource_representation
     )
